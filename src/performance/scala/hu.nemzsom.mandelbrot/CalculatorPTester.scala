...
object CalculatorPTester extends App {
  ...
  val testCases: List[(CalcPTest, Range)] = List(
    //CalcPTest(640, 480, Complex(-2, -1.65), 2.5, 1000, 100) -> 4,
    CalcPTest(640, 480, Complex(-1.4048486487084642, -3.546832668775599E-10), 5.092590793509544E-10, 25000, 5) -> (1 to 8 by 2)
  )
